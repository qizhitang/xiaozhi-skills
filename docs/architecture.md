...
本文档描述小智伴学 SKILL 库的完整清单、协作架构、数据契约、方法论依据与目录结构。当前版本 v2.1.11。
...
v2.1.11 的核心变化是把散落在各 SKILL 里的术语、阈值、降级规则、安全条款收敛到 `shared/`。所有 SKILL 只**引用**，不再各自定义。

...
Step 2  开场白——直接开口，不要准备
  → 学生说任何英语都可以接话
  → 收到"Good morning"后，如用户允许读取口语档案，可基于档案接话：
...
两轮无回复即收尾并归档："今天先到这儿，说过的我记下了，下次接着来。"
```
...
Step 4：记录进发音档案
  "这个 [音节] 的问题记到你的发音档案了（子类型 [P0X]）。
   下次热身开场我会先提醒你注意它。"
  → 落点：growthMap.oralGrowthTrack.pronunciationWeaknesses[]

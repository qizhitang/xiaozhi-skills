...
|---|---|
| **进入条件** | S2 完成后 |
| **AI动作** | 按优先级引导话题：①口语档案兴趣话题 ②上次未完成话题 ③话题库随机；说话过程中的规则：不打断／卡壳时按提示阶梯给一个词（有静默检测时约 5 秒触发，否则等学生说"我卡住了"）／好表达当场肯定 |
...
| 项 | 说明 |
|---|---|
| **AI动作** | 在 `profileEnabled=true` 时更新 `growthMap.oralGrowthTrack`（发音弱点仅限 audio_with_scoring / 连续热身天数 / 里程碑）+ 如有顽固弱项提醒下次注意 |
| **退出条件** | 两轮无回复即收尾并归档："今天先到这儿，说过的我记下了，下次接着来。" |

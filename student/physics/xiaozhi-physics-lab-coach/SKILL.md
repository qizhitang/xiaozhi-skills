...
依据《普通高中物理课程标准（2017 年版 2020 年修订）》必修 1 的四个学生必做实验（2025 年日常修订版如有调整，以修订版为准）。学生说明在读高一，或初中毕业后做衔接预习时用本节；初中学生仍按前面各节。
...
每个实验的操作顺序与原因、数据处理（含 CI 验算断言）、图像误差分析与常见错误见 `references/physics-hs1-labs.md`。追问方式不变："为什么要这样做？""如果不这样做会怎样？"。电火花计时器接 220 V 交流电源，安全口径按 shared/lab-safety.md，接线由老师检查。

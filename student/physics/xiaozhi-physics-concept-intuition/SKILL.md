...
description: >
  初中到高一的物理概念直觉建立器（高中部分目前覆盖高一必修第一册），用生活类比、头脑实验、公式推导三种模型把概念从"背下来"变成"真的懂了"。
...
依据《普通高中物理课程标准（2017 年版 2020 年修订）》必修 1（2025 年日常修订版如有调整，以修订版为准）。学生说明在读高一，或初中毕业后做衔接预习时用本节；初中学生仍按第二至六节，遇到高中概念只一句话说明"这是高中的内容"。

高一概念的直觉建立仍走"类比 → 追问 → 公式 → 迁移"三步，但有两点不同：
...
每个概念的类比、失效边界、迷思订正与检验问题见 `references/physics-hs1-misconceptions.md`。讲完请学生用自己的话讲一遍；检验问题若需新编，按 shared/ai-item-check.md 自检后再给出。更后面的高中概念（曲线运动、机械能、电场等）如实说明暂不覆盖。
...
本SKILL的类比素材库：
  ...
  references/physics-hs1-misconceptions.md（高一必修第一册的概念与迷思，见第七节）

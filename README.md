...
> 作者：小智伴学 ｜ 适用平台：WorkBuddy / SkillHub · OpenClaw / ClawHub ｜ 当前版本：**v2.4.0**
...
- 🧭 [学科扩展路线图](docs/roadmap-new-subjects.md) — 按各地中考与高考学科要求重排：物理高中化、化学、历史、高中生物与地理、数学高中化（第零批随 v2.1.13、第一批随 v2.2.0、第二批随 v2.3.0、第三批随 v2.4.0 发布；第四批已完成、待发版）

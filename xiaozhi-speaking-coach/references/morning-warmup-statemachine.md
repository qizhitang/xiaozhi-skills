...
> 本文档定义 `xiaozhi-speaking-coach` 核心工作流（模块A：晨间5分钟热身）的完整状态转移逻辑。
...
|---|---|
| **进入条件** | S1 完成后 |
| **分支** | **首次用户（S2_FIRST_TIME）**："先介绍一下自己吧，你叫什么，几年级，有什么爱好？"；**回头用户（S2_RETURNING）**：读取口语进化档案，基于档案接话（如"昨天'comfortable'重音放错了，今天顺带练一下"） |
...
| 项 | 说明 |
|---|---|
| **AI动作** | 更新口语进化档案（发音弱点/流利度/词汇记录/里程碑检查）+ 如有顽固弱点提醒下次注意 |

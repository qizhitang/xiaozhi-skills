...
description: >
  ...
  内置三个子模块：语法错误DNA档案 + 苏格拉底语法追问教练 + 定语从句专项训练营。
  核心工作流：三步生成语法基因图谱 → 苏格拉底四步追问 → DNA档案追踪 → 月度进步报告。
...
**触发：** 学生说"专项练定语从句"，或语法DNA显示定语从句错误≥3次
...
英语语法突破教练 SKILL
    ...
    ──→ 智能词汇DNA系统（介词搭配错误 → 存入词汇DNA）
    ──→ IM提醒SKILL（顽固弱项专项练习提醒）
    ──→ 定语从句专项训练营（错误≥3次自动触发）
```

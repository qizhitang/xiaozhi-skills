...
for (const doc of ["README.md", "docs/architecture.md"]) {
  ...
  const secCount = [
    ...
    [/学生端 · (语文|数学|英语|物理|化学)（(\d+)）/, (m) => count((s) => s.side === "student" && s.group === { 语文: "chinese", 数学: "math", 英语: "english", 物理: "physics", 化学: "chemistry" }[m[1]]), 2],
    [/老师端（(\d+)）/, () => nTeacher],

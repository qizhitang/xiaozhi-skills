...
- `references/lesson-log-template.md` — 课后记录 5 维度模板（待补）
- `references/learning-trail-view.md` — 学习轨迹视图模板（待补）
- `references/parent-brief-template.md` — 家长简报模板（待补）
